...
def save_model_artifacts(model, scaler, feature_importance):
    ...
    try:
        ...
        logger.info("Model saved to models/lower_face_paralysis_model.pkl")

        # Save scaler
        joblib.dump(scaler, 'models/lower_face_paralysis_scaler.pkl')
        logger.info("Scaler saved to models/lower_face_paralysis_scaler.pkl")
        ...
        joblib.dump(model, 'lower_face_paralysis_model.pkl')
        joblib.dump(scaler, 'lower_face_paralysis_scaler.pkl')
...
def main():
    ...
    joblib.dump(gb_model, 'models/gradient_boosting/lower_face_paralysis_model.pkl')
    joblib.dump(gb_scaler, 'models/gradient_boosting/lower_face_paralysis_scaler.pkl')
    gb_importance.to_csv('models/gradient_boosting/feature_importance.csv', index=False)
