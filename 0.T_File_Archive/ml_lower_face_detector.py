...
class MLLowerFaceParalysisDetector:
    """
    ...
    def __init__(self):
        ...
        try:
            ...
            if os.path.exists('models/lower_face_paralysis_model.pkl'):
            ...
            # Fall back to root directory
                ...
                self.model = joblib.load('lower_face_paralysis_model.pkl')
                self.scaler = joblib.load('lower_face_paralysis_scaler.pkl')
