...
import logging
from facial_au_constants import EXTREME_ASYMMETRY_THRESHOLD, MID_FACE_FUNCTIONAL_THRESHOLD, MID_FACE_FUNCTION_RATIO_OVERRIDE
        ...
        if au in right_values:
            ...
            if avg > 0:
                ...
                if ((zone == 'lower' and au_base == 'AU12_r') or 
                    ...
                    (zone == 'mid' and au_base == 'AU45_r')) and percent_diff > special_au_threshold:
