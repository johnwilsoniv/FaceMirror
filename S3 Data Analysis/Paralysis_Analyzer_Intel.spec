...
"""
PyInstaller spec file for S3 Paralysis Analyzer - Intel Mac Build
Builds a standalone application for facial paralysis detection and analysis

Usage:
    arch -x86_64 pyinstaller Paralysis_Analyzer_Intel.spec

Output:
    dist/Paralysis Analyzer.app  (macOS application bundle for Intel)
"""
...
# XGBoost native library - use the one from the x86_64 venv
binaries = []
# PyInstaller will automatically collect xgboost's native library from the active environment
...
a = Analysis(
    ...
    excludes=[
        ...
        'torch',
        'tensorflow',
        'numba',  # Exclude numba (optional acceleration, causes llvmlite issues)
        'llvmlite',
        'fasttreeshap',
    ],
