...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print("WHISPER ENGINE DETECTION")
    print("=" * 70)
    mlx_available = False
    mlx_import_failed = None
    silero_import_failed = None
    ...
    try:
        ...
        mlx_available = False
        print("=" * 70)
        print(">>> USING FASTER-WHISPER (FALLBACK) <<<")
        if mlx_import_failed:
            print(f"  MLX import failed: {mlx_import_failed}")
        if silero_import_failed:
            print(f"  Silero VAD import failed: {silero_import_failed}")
        print("  Will preload faster-whisper model...")
        print("=" * 70)
