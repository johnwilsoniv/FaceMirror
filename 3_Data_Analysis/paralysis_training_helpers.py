...
# --- Logging Helper (unchanged from previous full version) ---
...
# --- Data Augmentation (unchanged from previous full version, typically disabled by config) ---
...
# --- SMOTE Helpers (unchanged from previous full version) ---
    ...
    def objective(trial):
        with warnings.catch_warnings():
            ...
            for fold_idx, (train_idx, val_idx) in enumerate(cv_obj_outer_optuna.split(X_train_scaled_np, y_train_np)):
                ...
                # --- Pre-fit XGBoost for this Optuna fold ---
                ...
                # --- RF and ET (unfitted, will be fit by VotingClassifier) ---
...
# --- Thresholding Helpers (unchanged from previous full version) ---
...
# --- Model I/O Helpers (unchanged from previous full version) ---
...
# --- Reporting & Analysis Helpers (unchanged from previous full version) ---
...
# --- Class Weight Calculation (unchanged from previous full version) ---
...
# --- General Helpers for Model Trainer (unchanged from previous full version) ---
