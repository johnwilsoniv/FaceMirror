...
class ApplicationController(QObject):
    ...
    def _initiate_save(self): # (Unchanged)
        ...
        try:
            ...
            output_folder_name = "2.5_Coded_Files"; output_dir = os.path.join(batch_parent_dir, output_folder_name); os.makedirs(output_dir, exist_ok=True)
